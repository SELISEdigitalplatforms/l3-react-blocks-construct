...
const meta: Meta<typeof BasePasswordForm> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'A form component for password creation/reset that includes validation, strength checking, and optional CAPTCHA verification for enhanced security.',
      },
    },
  },
  argTypes: {
...
export const Default: Story = {
  render: (args) => {
    ...
    const handleSubmit = async (password: string, code: string, captchaToken?: string) => {
      setIsPending(true);
      console.log('Form submitted:', { password: '***', code, captchaToken: captchaToken ? '***' : undefined });
...
export const WithCode: Story = {
  render: (args) => {
    ...
    const handleSubmit = async (password: string, code: string, captchaToken?: string) => {
      setIsPending(true);
      console.log('Password reset with code:', { code, hasPassword: !!password, hasCaptcha: !!captchaToken });
