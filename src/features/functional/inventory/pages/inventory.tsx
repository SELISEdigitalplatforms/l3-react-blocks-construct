...
import { AdvancedTableColumnsToolbar } from 'features/functional/inventory/component/advance-table-columns-toolbar/advance-table-columns-toolbar';
import AdvanceDataTable from 'features/functional/inventory/component/advance-data-table/advance-data-table';
import { createAdvanceTableColumns } from 'features/functional/inventory/component/advance-table-columns/advance-table-columns';
import { AdvanceTableFilterToolbar } from 'features/functional/inventory/component/advance-table-filter-toolbar/advance-table-filter-toolbar';
import { AdvanceExpandRowContent } from 'features/functional/inventory/component/advance-expand-row-content/advance-expand-row-content';
import { useGetInventories } from 'features/functional/inventory/hooks/use-inventory';
import { InventoryItem } from 'features/functional/inventory/types/inventory.types';
