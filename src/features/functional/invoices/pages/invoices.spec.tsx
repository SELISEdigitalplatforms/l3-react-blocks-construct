...
import { createInvoiceTableColumns } from 'features/functional/invoices';
import '@testing-library/jest-dom';
import { MemoryRouter } from 'react-router-dom';
import { InvoicesPage } from './invoices';
import { InvoiceItem } from 'features/functional/invoices/types/invoices.types';
...
jest.mock('features/functional/invoices/hooks/use-invoices', () => ({
  useGetInvoiceItems: () => mockUseGetInvoiceItems(),
}));

// Mock the features/functional/invoices components
jest.mock('features/functional/invoices', () => ({
  __esModule: true,
