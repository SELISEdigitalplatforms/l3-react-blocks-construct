...
import { IFileTrashData } from 'features/functional/file-manager/utils/file-manager';
import { TrashFilesListView } from 'features/functional/file-manager/components/trash/trash-files-list-view';
import { TrashGridView } from 'features/functional/file-manager/components/trash/trash-files-grid-view';
import { TrashFilters } from 'features/functional/file-manager/types/header-toolbar.type';
import { TrashHeaderToolbar } from 'features/functional/file-manager/components/trash/trash-files-header-toolbar';
import { useNavigate, useParams } from 'react-router-dom';
import { useMockTrashFilesQuery } from 'features/functional/file-manager/hooks/use-mock-trash-files-query';
