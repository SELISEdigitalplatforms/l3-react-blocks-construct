...
import SharedFilesListView from 'features/functional/file-manager/components/shared-with-me/shared-files-list-view';
import { ShareWithMeModal } from 'features/functional/file-manager/components/modals/shared-user-modal';
import { RenameModal } from 'features/functional/file-manager/components/modals/rename-modal';
import SharedFilesGridView from 'features/functional/file-manager/components/shared-with-me/shared-files-grid-view';
import { useFileManager } from 'features/functional/file-manager/hooks/use-file-manager';
import { useFileFilters } from 'features/functional/file-manager/hooks/use-file-filters';
import { FileModals } from 'features/functional/file-manager/components/modals/file-modals';
import { FileManagerLayout } from 'features/functional/file-manager/file-manager-layout';
import { FileViewRenderer } from 'features/functional/file-manager/components/file-view-renderer';
import { SharedFilters } from 'features/functional/file-manager/types/header-toolbar.type';
import { SharedWithMeHeaderToolbar } from 'features/functional/file-manager/components/shared-with-me/shared-files-header-toolbar';
import { useNavigate, useParams } from 'react-router-dom';
import { FilePreview } from 'features/functional/file-manager/components/file-preview';
