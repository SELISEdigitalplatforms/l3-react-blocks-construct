...
import MyFilesListView from 'features/functional/file-manager/components/my-files/my-files-list-view';
...
import MyFileGridView from 'features/functional/file-manager/components/my-files/my-files-grid-view';
...
import { FileFilters } from 'features/functional/file-manager/components/common-filters';
import { FileManagerHeaderToolbar } from 'features/functional/file-manager/components/my-files/my-files-header-toolbar';
