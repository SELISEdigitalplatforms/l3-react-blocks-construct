...
import { TaskItem } from 'features/functional/task-manager/types/task-manager.types';
import {
  NewTaskRow,
  SortableTaskItem,
  StatusCircle,
  TableHeader,
} from 'features/functional/task-manager/components/list-view';
import { Dialog } from 'components/ui/dialog';
import TaskDetailsView from 'features/functional/task-manager/components/task-details-view/task-details-view';
import { useListTasks } from 'features/functional/task-manager/hooks/use-list-tasks';
...
import { ItemTag } from 'features/functional/task-manager/types/task-manager.types';
