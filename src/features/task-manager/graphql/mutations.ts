...
/**
 * GraphQL Mutations for Task Attachmetn
 *
 * This file contains GraphQL mutation strings for task management operations.
 * These mutations are used with the graphqlClient for creating, updating, and deleting
 * task manager attachment, including tracking impacted data and acknowledgments.
 */

export const INSERT_TASK_ATTACHMENT_MUTATION = `
  mutation InsertTaskAttachment($input: TaskAttachmentInsertInput!) {
    insertTaskAttachment(input: $input) {
      itemId
      totalImpactedData
      acknowledged
    }
...
export const UPDATE_TASK_ATTACHMENT_MUTATION = `
  mutation UpdateTaskAttachment($filter: String!, $input: TaskAttachmentUpdateInput!) {
    updateTaskAttachment(filter: $filter, input: $input) {
      itemId
      totalImpactedData
      acknowledged
    }
...
export const DELETE_TASK_ATTACHMENT_MUTATION = `
  mutation DeleteTaskAttachment($filter: String!, $input: TaskAttachmentDeleteInput!) {
    deleteTaskAttachment(filter: $filter, input: $input) {
      itemId
      totalImpactedData
      acknowledged
    }
