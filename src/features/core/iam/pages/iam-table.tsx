...
import { useForgotPassword, useResendActivation } from 'features/core/auth/hooks/use-auth';
import { useGetUsersQuery } from 'features/core/iam/hooks/use-iam';
import { createIamTableColumns } from 'features/core/iam/components/iam-table/iam-table-columns';
import { IamTableToolbar } from 'features/core/iam/components/iam-table/iam-table-toolbar';
import { IamData } from 'features/core/iam/services/user-service';
import { useIsMobile } from 'hooks/use-mobile';
import ExpandedUserDetails from 'features/core/iam/components/user-details-mobile-view/expanded-user-details';
import DataTable from 'components/blocks/data-table/data-table';
import { Button } from 'components/ui/button';
import { Dialog, DialogTrigger } from 'components/ui/dialog';
import { AddUser } from 'features/core/iam/components/add-profile/add-profile';
import { UserDetails } from 'features/core/iam';
